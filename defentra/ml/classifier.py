...
from defentra.ml.features import FEATURE_NAMES, FEATURE_VERSION
...
class MalwareClassifier:
    ...
    Models are searched in $DEFENTRA_MODEL, then $DEFENTRA_MODEL_DIR,
    then ~/.defentra/models/, then the bundled models dir. A sibling
